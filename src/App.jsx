...
//     fetch('https://jsonb-rouge.vercel.app/courses')
...
//     fetch('https://jsonb-rouge.vercel.app/cart')
//       .then(response => response.json())// Convert response to JSON
...
//     fetch(`https://jsonb-rouge.vercel.app/cart/${id}`, {//send a delete request to the server
//       method: 'DELETE',
//     })
//     .then(() => {
...
const App = () => {
  ...
  useEffect(() => {
    // Fetch data from JSON Server
    axios.get('https://jsonb-rouge.vercel.app/courses')
  ...
  useEffect(() => {
    // Fetch cart data from JSON Server
    axios.get('https://jsonb-rouge.vercel.app/cart')
  ...
  // Function to add a course to the cart
  const handleAddToCart = (course) => {
    axios.post('https://jsonb-rouge.vercel.app/cart', course, {
      headers: { 'Content-Type': 'application/json' }
    })
  ...
  // Function to remove an item from the cart by its ID
  const handleRemoveFromCart = (id) => {
    axios.delete(`https://jsonb-rouge.vercel.app/cart/${id}`)
      .then(() => {
